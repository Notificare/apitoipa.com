...
const TickerSlider = () => (
    <StaticQuery
        query={graphql`
          query partnersTickerImagesQuery {
            source: allFile(filter: { absolutePath: { regex: "/partners-logos/" } }) {
              edges {
                node {
                  name
                  publicURL
...
const PartnersTicker = ({intl, content}) => (
...
export default injectIntl(PartnersTicker)
